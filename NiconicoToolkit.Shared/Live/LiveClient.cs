...
[JsonSerializable(typeof(LiveWatchPageDataProp))]
public sealed partial class LiveSourceGenerationContext : JsonSerializerContext
{
...
public sealed class LiveClient
{
    ...
    internal LiveClient(NiconicoContext context, JsonSerializerOptions defaultOptions)
    {
        ...
        _watchPageJsonSerializerOptions = new JsonSerializerOptions(NiconicoContext.DefaultOptionsSnakeCase) 
        {
            TypeInfoResolver = LiveSourceGenerationContext.Default,
        };
    }
