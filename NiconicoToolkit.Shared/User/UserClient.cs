...
[JsonSerializable(typeof(UserNicknameResponse))]
[JsonSerializable(typeof(UserDetailResponse))]
[JsonSerializable(typeof(UserVideoResponse))]
[JsonSerializable(typeof(UsersResponse))]
public sealed partial class UserJsonSourceGenerationContext : JsonSerializerContext
{
}
...
public sealed class UserClient
{
    ...
    internal UserClient(NiconicoContext context, JsonSerializerOptions options)
    {
        _context = context;
        _options = new(options)
        {
            TypeInfoResolverChain = { UserJsonSourceGenerationContext.Default }
        };
    }
