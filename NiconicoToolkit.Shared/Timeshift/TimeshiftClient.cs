...
[JsonSerializable(typeof(ReserveTimeshiftResponse))]
[JsonSerializable(typeof(TimeshiftReservationsResponse))]
public sealed partial class TimeshiftJsonSourceGenerationContext : JsonSerializerContext
{
}
...
public sealed class TimeshiftClient
{
    ...
    internal TimeshiftClient(NiconicoContext context, JsonSerializerOptions defaultOptions)
    {
        ...
        {
            TypeInfoResolverChain = { TimeshiftJsonSourceGenerationContext.Default },
            Converters = 
            {
    ...
    public Task<ReserveTimeshiftResponse> ReserveTimeshiftAsync(LiveId liveId, bool overwrite)
    {
        ...
        return _context.SendJsonAsAsync<ReserveTimeshiftResponse>(httpMethod: HttpMethod.Post, Urls.TimeshiftReservationApiUrl, httpContent: null, _options);
    }
