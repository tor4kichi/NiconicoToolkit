...
[JsonSerializable(typeof(AndJsonFilterData))]
[JsonSerializable(typeof(OrJsonFilterData))]
[JsonSerializable(typeof(NotJsonFilterData))]
[JsonSerializable(typeof(EqualJsonFilterData))]
[JsonSerializable(typeof(RangeJsonFilterData))]
[JsonSerializable(typeof(IJsonSearchFilterData))]
public sealed partial class SnapshotSearchFiltersJsonSourceGenerationContext : JsonSerializerContext
{
}
...
public sealed partial class SnapshotSearchJsonSourceGenerationContext : JsonSerializerContext
{
}
...
public sealed class VideoSnapshotSearchClient
{
	...
	internal VideoSnapshotSearchClient(NiconicoContext context, System.Text.Json.JsonSerializerOptions options)
	{
		_context = context;
		_options = new(options) 
		{
			TypeInfoResolverChain = { SnapshotSearchJsonSourceGenerationContext.Default }
		};
	}

	public async Task<DateTimeOffset> GetSnapshotVersionAsync()
	{
		var result = await _context.GetJsonAsAsync<SnapshotApiVersion>(SearchConstants.SearchApiVersionUrl, _options);
	...
	*/
		...
		)
	{
		...
		return await _context.GetJsonAsAsync<SnapshotResponse>(url, _options, cancellationToken);
	}
}
