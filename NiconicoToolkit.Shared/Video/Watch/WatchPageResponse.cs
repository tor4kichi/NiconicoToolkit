...
public class NicoVideoWatchApiResponse : ResponseWithData<NicoVideoWatchApiData>
{
...
public class NicoVideoWatchApiData
{
    ...
    public WatchResponse Response { get; set; }
}

public class WatchDomand
{
    [JsonPropertyName("videos")]
    public List<VideoContent> Videos { get; set; }

    [JsonPropertyName("audios")]
    public List<AudioContent> Audios { get; set; }
...
public class Media
{
    ...
    public WatchDomand Domand { get; set; }
